...
% \includecode{file}{../code/Basic/file.cpp}
\includecode{hash.py}{../code/Basic/hash.py}
...
\includecode{SegTree [b24dad]}{../code/DataStructure/SegTree.cpp}
\includecode{PersistentSegTree [badc03]}{../code/DataStructure/PersistentSegTree.cpp}
\includecode{SegTreeBeat [e03d2a]}{../code/DataStructure/SegTreeBeat.cpp}
% \includecode{Link Cut Tree}{../code/DataStructure/LinkCutTree.cpp}
\includecode{LiChao_Max [8aaa4c]}{../code/DataStructure/LiChao.cpp}
...
\includecode{Hungary [77c0cb]}{../code/Flow/Hungary.cpp}
...
\includecode{Line [204142]}{../code/Geometry/Line.cpp}
...
\includecode{Convex Trick [707382]}{../code/Geometry/ConvexTrick.cpp}
...
\includecode{CentroidDecomp [9e13e4]}{../code/Graph/CentroidGan.cpp}
...
\includecode{HLD [d3281a]}{../code/Graph/HLD.cpp}
...
\includecode{Aho-Corasick AM [3a82e2]}{../code/String/ACM.cpp}
\includecode{Double String [1cdb3b]}{../code/String/DoubleString.cpp}
\includecode{KMP [7cd651]}{../code/String/KMP.cpp}
...
% \includecode{Minimal Rotation}{../code/String/Minimal_Rotation.cpp}
